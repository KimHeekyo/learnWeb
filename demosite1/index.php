...
<body>
  ...
  <header>
    <div class="headeritem">로고</div>
    <div class="headeritem">메뉴1</div>
    <div class="headeritem">메뉴2</div>
    <div class="loginlink">
    <?php
      if (!$chk_login) {  // 로그인 상태가 아니라면
      ?>
        <button id='trglgnModal'>로그인</button>
        <!-- 여기부터 login modal -->
  ...
  <nav>
    <ul>
      <li><a href="/memo/memo_list.php">메모</a></li>
